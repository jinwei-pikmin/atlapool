...
| `jira_add_comment` | Add a comment to a Jira issue | `issue_key`, `body` (ADF object or stringified JSON; plain text strings are wrapped as a paragraph ADF) | `projects` (parsed from key) | Yes | Yes |
